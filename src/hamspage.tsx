...
function hamspage() {
  return (
    <div>
    <h4 className=''>This is HamsPay official Page with Airdrop</h4>
    <h5 className=''>Copy the link and send to your friends: you will be rewarded with $5,000 for each referral</h5>
  <div className="butt">
