...
function App() {
  ...
  "Master", //
  "GrandMaster", //
  "Lord" // From 1,000,000,000 coin to --
...
const minutes = Math.floor((diff % (100 * 60 * 60)) / (1000 * 60));
...
return () => clearInterval(interval);}, [profitPerHour]);
...
<Hamster size={24} className="text-[#1d4d4d4]"/>
...
<div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-[calc(100%-2rem)] max-w-xl bg-[#272a2f] flex justify-around items-center z-50 rounded-3xl text-xs">
  ...
  <p className="mt-1"><a href="https://hamspayment.netlify.app/hamspage.tsx">Friends</a></p>
  </div>
...
{clicks.map((click) => (
<div key={click.id} className="absolute text-5xl font-bold opacity-0 text-white pointer-events-none" style={{top: `${click.y - 42}px`, left: `${click.x - 28}px`, animation: `float 1s ease-out`}}
